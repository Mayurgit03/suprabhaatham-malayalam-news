  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        headline: {
          primary: "hsl(var(--headline-primary))",
          secondary: "hsl(var(--headline-secondary))",
        },
        ...
        category: {
          ...
          gulf: "hsl(var(--category-gulf))",
        },
      },
      backgroundImage: {
        'gradient-hero': 'var(--gradient-hero)',
        'gradient-breaking': 'var(--gradient-breaking)',
      ...
      animation: {
        ...
        "pulse-breaking": "pulse-breaking 2s ease-in-out infinite",
